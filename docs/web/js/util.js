...
const FX_DEFS = {
  ...
  amp: { nameKey: 'fx_amp', fallback: 'Amp',
    p: { gain:  { min: 0, max: 100, step: 1, def: 62, labelKey: 'fx_gain', labelFb: 'Gain' },
         tone:  { min: 0, max: 100, step: 1, def: 55, labelKey: 'fx_tone', labelFb: 'Tone' },
         level: { min: 0, max: 1, step: 0.01, def: 0.7, labelKey: 'fx_level', labelFb: 'Level' } } },
